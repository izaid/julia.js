...
'OTHER_LDFLAGS': ['<!@(/Applications/Julia-0.5.app/Contents/Resources/julia/share/julia/julia-config.jl --ldflags)'],
    ...
    },
    {
      ...
      "include_dirs": ["include"],
        'libraries': ['-lv8',  '-lv8_base', '-lv8_libbase', '-lv8_snapshot', '-lv8_libplatform', '<!@(/Applications/Julia-0.5.app/Contents/Resources/julia/share/julia/julia-config.jl --ldlibs)'],
      "xcode_settings": {
